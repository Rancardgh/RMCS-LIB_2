...
public class ProfilesBean extends roles implements java.io.Serializable {
...
//}
    ...
    public void verifyUser()throws Exception {
        ...
        ProfilesBean  bean=Profile.verifyUser(username);
        username=bean.getusername();
        password=bean.getpassword();
        role_id=bean.getRole_id();
    ...
    public boolean isValidUser()throws Exception {
        ...
        ProfilesBean bean;
        try {
            bean = Profile.verifyUser(this.username, this.password);
