...
/* 39:   */     try
/* 40:   */     {
/* 41:42 */       Thread.sleep(this.delay);
/* 42:43 */       Driver.getDriver(this.cnxn.getDriverType(), this.cnxn.getGatewayURL()).sendSMSTextMessage(this.msisdn, this.short_code, this.message, this.cnxn.getUsername(), this.cnxn.getPassword(), this.cnxn.getConnection(), this.meta_data);
/* 43:   */     }
/* 44:   */     catch (InterruptedException e)
/* 45:   */     {
/* 46:46 */       System.out.println(new Date() + ": " + this.short_code + ": " + this.msisdn + ": thread error sending notification @ ThreadedMessageSender: " + e.getMessage());
/* 47:   */     }
/* 48:   */     catch (Exception e)
/* 49:   */     {
/* 50:48 */       System.out.println(new Date() + ": " + this.short_code + ": " + this.msisdn + ": error sending notification @ ThreadedMessageSender: " + e.getMessage());
/* 51:   */     }
/* 52:   */     finally
/* 53:   */     {
/* 54:50 */       this.cnxn = null;
/* 55:   */     }
/* 56:   */   }
/* 57:   */ }
 ...
 * Qualified Name:     com.rancard.common.ThreadedMessageSender
