...
public abstract class ServiceManager {
    ...
    public static void deleteService(String keyword, String accountId) throws
            Exception {
        UserServiceDB.deleteService(keyword, accountId);
    }

    public static void deleteService(ArrayList keywords, String accountId) throws
            Exception {
        UserServiceDB.deleteService(keywords, accountId);
    }

    public static UserService viewService(String keyword, String accountId) throws
            Exception {
        return UserServiceDB.viewService(keyword, accountId);
    }

    public static UserServiceExperience viewServiceExperience(String accountId, String siteId, String keyword) throws
            Exception {
        return UserServiceExperienceDB.viewServiceExperience(accountId, siteId, keyword);
    }

    public static void deleteServiceExperience(String accountId, String keyword) throws
            Exception {
        UserServiceExperienceDB.deleteServiceExperience(accountId, keyword);
    }

    public static void deleteServiceExperience(String accountId, ArrayList keywords) throws
            Exception {
        UserServiceExperienceDB.deleteServiceExperience(accountId, keywords);
    }

    public static void updateServiceExperience(String accountId, String keyword, UserServiceExperience serviceExperience) throws Exception {

        UserServiceExperienceDB.updateServiceExperience(accountId, keyword, serviceExperience);
    }
    //Feeds
    public static void createFeed(com.rancard.mobility.infoserver.feeds.Feed feed) throws Exception {
    ...
    public static void deleteFeed(ArrayList feedIds) throws Exception {
    ...
    //CP User Feeds
    public static void createCPUserFeedAssociation(com.rancard.mobility.infoserver.feeds.CPUserFeeds cpUserFeed) throws Exception {
    ...
    public static void deleteCPUserFeed(String account_id, ArrayList keywords) throws Exception {
    ...
    //Service Labels
     public static void createServiceLabel(String account_id, String keyword, String header, String footer) throws Exception {
    ...
    public static void updateServiceLabel(String update_account_id, String update_keyword, String new_account_id, String new_keyword,
            String new_header,String new_footer) throws Exception {
    ...
    // specified alias
    public static UserService viewServiceByAlias(String alias, String accountId) throws
            Exception {
    ...
    public static int[] updateServicesRSSFeeds(String accountId, String keyword, java.util.ArrayList feedIds) throws Exception {
    ...
    public static Page viewSubscribers(String csid, String[] keywords, java.sql.Timestamp startdate,
    ...
    public static HashMap viewSubscribersGroupByNetworkPrefix(String accountid, String keyword, int status) throws Exception {
        return UserServiceDB.viewSubscribersGroupByNetworkPrefix(accountid, keyword, status);
    }

    public static HashMap viewSubscribersGroupByNetworkPrefix(String accountid, String keyword, String alias, int status) throws Exception {
    ...
    public static String viewNextSubscriptionDate(String msisdn, String accountId, String keyword) throws Exception {
