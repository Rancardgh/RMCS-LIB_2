...
public class EndlessOddsWithQuestion extends Competition {
    public EndlessOddsWithQuestion() {
        super();
        this.setParticipationLimit(CompetitionManager.INFINITE_PARTICIPATION);
        this.setType(CompetitionManager.ENDLESS_ODDS_QUESTION_BACK);
    }

    public EndlessOddsWithQuestion(String serviceType, String serviceName, String defaultMessage, String keyword, String desc, String thumburl,
