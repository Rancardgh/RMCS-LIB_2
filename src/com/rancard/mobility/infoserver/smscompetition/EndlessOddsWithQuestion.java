...
/*  7:   */ 
/*  8:   */ public class EndlessOddsWithQuestion
/*  9:   */   extends Competition
/* 10:   */ {
/* 11:   */   public EndlessOddsWithQuestion()
/* 12:   */   {
/* 13:11 */     setParticipationLimit("*");
/* 14:12 */     setType(2);
/* 15:   */   }
/* 16:   */   
/* 17:   */   public EndlessOddsWithQuestion(String serviceType, String serviceName, String defaultMessage, String keyword, String desc, String thumburl, String limit, String accountId, int type, int partLevel, Timestamp start, Timestamp end, ArrayList prizes, String qstn, ArrayList opt, String ans, ArrayList altAns)
/* 18:   */   {
 ...
 * Qualified Name:     com.rancard.mobility.infoserver.smscompetition.EndlessOddsWithQuestion
