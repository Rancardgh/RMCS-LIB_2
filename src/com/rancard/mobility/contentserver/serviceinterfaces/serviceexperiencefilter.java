...
public class serviceexperiencefilter
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain filterChain)
        ...
        final String accountId = (String) req.getAttribute("acctId");
        ...
        try {
            ...
            if (srvcExpr != null) {
                    ...
                    if (alreadySubscribed) {
                        ...
                        if ((nextSubscriptionDate == null) || (nextSubscriptionDate.after(curTimestamp))) {
                            ...
                            if (isInActive) {
                                ...
                                renewalMessage = srvcExpr.getAlreadySubscribedMsg();
                            }
                ...
                if (!skipMessagePush) {
                    int pushMsgWaitTime = srvcExpr.getPushMsgWaitTime();


                    String flashPush = (String) metaDataMap.get("push_msg_flash".toUpperCase());
                    if ((flashPush != null) && (flashPush.equals("1"))) {
                        CPConnections cnxn = CPConnections.getConnection(accountId, msisdn, "kannel");
    ...
    private void vmAcceptance(String accountId, String keyword, String msisdn, String serviceName, String shortCode, String smsc) {
        ...
        try {
            ...
            System.out.println(new java.util.Date() + " " + serviceexperiencefilter.class + ":ERROR Exception caught processing viral marketing step 2: acceptance " + exc.getMessage());
        }
    }
