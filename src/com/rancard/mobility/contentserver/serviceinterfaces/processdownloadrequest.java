...
/* 706:    */       try
/* 707:    */       {
/* 708:704 */         if (siteType.equals("2")) {
/* 709:705 */           message = feedback.getUserFriendlyDescription(e.getMessage());
/* 710:    */         } else {
/* 711:707 */           message = message;
/* 712:    */         }
/* 713:709 */         if (message == null) {
/* 714:710 */           message = e.getMessage();
/* 715:    */         }
/* 716:    */       }
/* 717:    */       catch (Exception ex)
/* 718:    */       {
/* 719:713 */         message = ex.getMessage();
/* 720:    */       }
/* 721:715 */       if ((responsePath != null) && (!responsePath.equals("")) && (!responsePath.equalsIgnoreCase("null"))) {
/* 722:716 */         response.sendRedirect(responsePath + "?reply=" + message);
/* 723:    */       } else {
/* 724:718 */         out.println(message);
/* 725:    */       }
/* 726:720 */       return;
/* 727:    */     }
/* 728:    */     finally
/* 729:    */     {
/* 730:723 */       cnxn = null;
/* 731:724 */       download = null;
/* 732:725 */       format = null;
/* 733:726 */       initSite = null;
/* 734:727 */       item = null;
/* 735:728 */       out = null;
/* 736:729 */       user = null;
/* 737:    */     }
/* 738:    */   }
/* 739:    */   
/* 740:    */   public void doPost(HttpServletRequest request, HttpServletResponse response)
/* 741:    */     throws ServletException, IOException
/* 742:    */   {
/* 743:738 */     doGet(request, response);
/* 744:    */   }
/* 745:    */   
/* 746:    */   public void destroy() {}
/* 747:    */   
/* 748:    */   private void initiateDownload(String baseUrl, String ticket)
/* 749:    */     throws Exception
/* 750:    */   {
/* 751:746 */     BufferedReader br = null;
/* 752:747 */     URL url = null;
/* 753:    */     try
/* 754:    */     {
/* 755:750 */       url = new URL(baseUrl + "initiatedownload?ticketId=" + ticket);
/* 756:    */       
/* 757:752 */       System.out.println(" Initiate download URL: " + url);
/* 758:    */       
/* 759:754 */       br = new BufferedReader(new InputStreamReader(url.openStream()));
/* 760:    */       
/* 761:756 */       String temp = br.readLine();
/* 762:757 */       String resp = new String();
/* 763:759 */       while (temp != null)
/* 764:    */       {
/* 765:760 */         resp = resp + temp;
/* 766:761 */         temp = br.readLine();
/* 767:    */       }
/* 768:764 */       br.close();
/* 769:    */     }
/* 770:    */     catch (IOException ex2)
/* 771:    */     {
/* 772:766 */       System.out.println("Error: " + ex2.getMessage());
/* 773:767 */       throw new Exception("8000");
/* 774:    */     }
/* 775:    */     finally
/* 776:    */     {
/* 777:769 */       url = null;
...
/* 780:    */   }
/* 781:    */   
/* 782:    */   public String log(int idLength, Transaction dlb, String formatID, String keyword)
/* 783:    */   {
/* 784:776 */     String ticket = null;
/* 785:777 */     dlb.setTicketID(uidGen.getUId() + "-" + formatID);
/* 786:    */     try
/* 787:    */     {
/* 788:780 */       Transaction.logTransaction(dlb.getTicketID(), dlb.getID(), dlb.getListID(), dlb.getSubscriberMSISDN(), dlb.getPhoneId(), false, dlb.getPin(), dlb.getSiteId(), keyword);
/* 789:781 */       ticket = dlb.getTicketID();
/* 790:    */     }
/* 791:    */     catch (Exception e)
/* 792:    */     {
/* 793:783 */       e.printStackTrace();
/* 794:    */     }
/* 795:785 */     return ticket;
/* 796:    */   }
/* 797:    */   
/* 798:    */   public void forward(ServletRequest request, ServletResponse response)
/* 799:    */     throws ServletException, IOException
/* 800:    */   {
/* 801:790 */     HttpServletRequest req = (HttpServletRequest)request;
/* 802:791 */     HttpServletResponse resp = (HttpServletResponse)response;
/* 803:792 */     doGet(req, resp);
/* 804:    */   }
/* 805:    */   
/* 806:    */   public void include(ServletRequest request, ServletResponse response)
/* 807:    */     throws ServletException, IOException
/* 808:    */   {
/* 809:797 */     HttpServletRequest req = (HttpServletRequest)request;
/* 810:798 */     HttpServletResponse resp = (HttpServletResponse)response;
/* 811:799 */     doGet(req, resp);
/* 812:    */   }
/* 813:    */ }
