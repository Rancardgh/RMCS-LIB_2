...
public class RMCSFreemiumProcessor
        implements FreemuimPocessor
{
    public boolean freemuimExists(String id)
            throws Exception
    {
        try
        {
    ...
    public boolean freemuimExists(String accountID, String keyword)
            throws Exception
    {
        try
        {
    ...
    public List<Freemium> getFreemiums(String accountID, String keyword)
            throws Exception
    {
        return FreemiumDB.getFreemuim(accountID, keyword);
    }

    public Freemium getFreemium(String id)
            throws Exception
    {
        return FreemiumDB.getFreemuim(id);
    }

    public boolean process(String msisdn, String accountID, String keyword)
            throws Exception
    {
    ...
    public List<Freemium> getActiveFreemiums(String accountID, String keyword)
            throws Exception
    {
