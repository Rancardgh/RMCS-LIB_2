...
<head><title>www.rancardmobility.com - User Login</title>
...
<div class="lball">
	<div class="lblayout lbtopmargin" style="width: 500px; height: 25px"><p>
		<span class="logotext" >CikaNet Administrative Console Login</span></p></div>
	<div class="lblayout lbcontainer">
			...
			<div class="lbfields">
				...
				<div class="lbinput">
					...
					<input type="hidden" name="redirect" value="<%=response.encodeURL(request.getParameter("redirect"))%>"/>
                                                        <%} %></p>
					</form>
				</div>
			</div>
	</div>
	<div class="lblayout footer">Copyright 2001-2005 Rancard Solutions Ltd.</div>
</div>
</body></html>
